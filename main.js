const postsEl = document.getElementById('box');
const btn = document.getElementById('all_posts');
const btns = document.getElementById('buttonn');
...
const func = async () => {
    ...
    const phonk = (userId) => {
        postsEl.innerHTML = '';
        const filteredPosts = data.filter((box) => box.userId === userId);
